...
public class ResourceUtils {
	...
	/**
	 * 获得相对路径
	 * @param file 目标文件 ，例如 /Users/
	 * @param startDir 起止目录  ，例如 /Users/Desktop/tmp.txt
	 * @return 相对路径，例如 /Desktop/tmp.txt
	 */
	public static String getSubPath(File file, File startDir){
		Assert.notNull(file,"文件不能为空");
		if(startDir == null )return file.getAbsolutePath();
		String startDirName = startDir.getAbsolutePath();
		String filePath = file.getAbsolutePath();
		if(filePath.startsWith(startDirName)){
			return filePath.substring(startDirName.length());
		}
